...
export default function SkillsBar() {
  return (
    <div className="w-full max-w-xl mx-auto my-10">
      <h3 className="text-2xl font-bold mb-4 text-blue-700 dark:text-blue-300 text-center">
        ...
        {skills.map((skill, idx) => (
          <div key={skill.label}>
            <div className="flex justify-between mb-1">
              <span className="font-semibold text-gray-800 dark:text-gray-100">{skill.label}</span>
              <span className="text-sm font-mono text-gray-600 dark:text-gray-300">{skill.value}%</span>
            </div>
